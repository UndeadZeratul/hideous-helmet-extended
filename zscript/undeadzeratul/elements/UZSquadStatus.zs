class UZSquadStatus : HUDElement {
    ...
    override void Tick(HCStatusbar sb) {
        ...
        if (!_hlm_scaleX) _hlm_scaleX                       = CVar.GetCVar("uz_hhx_"..Namespace.."_hlm_xscale", sb.CPlayer);
        if (!_hlm_scaleY) _hlm_scaleY                       = CVar.GetCVar("uz_hhx_"..Namespace.."_hlm_yscale", sb.CPlayer);
        ...
        if (!_nhm_scaleX) _nhm_scaleX                       = CVar.GetCVar("uz_hhx_"..Namespace.."_nhm_xscale", sb.CPlayer);
        if (!_nhm_scaleY) _nhm_scaleY                       = CVar.GetCVar("uz_hhx_"..Namespace.."_nhm_yscale", sb.CPlayer);
        ...
        if (!_name_enabled) _name_enabled                   = CVar.GetCVar("uz_hhx_"..Namespace.."_name_enabled", sb.CPlayer);
        if (!_name_nhm_posX) _name_nhm_posX                 = CVar.GetCVar("uz_hhx_"..Namespace.."_name_nhm_posX", sb.CPlayer);
        if (!_name_nhm_posY) _name_nhm_posY                 = CVar.GetCVar("uz_hhx_"..Namespace.."_name_nhm_posY", sb.CPlayer);
        if (!_name_nhm_scale) _name_nhm_scale               = CVar.GetCVar("uz_hhx_"..Namespace.."_name_nhm_scale", sb.CPlayer);
        if (!_name_hlm_posX) _name_hlm_posX                 = CVar.GetCVar("uz_hhx_"..Namespace.."_name_hlm_posX", sb.CPlayer);
        if (!_name_hlm_posY) _name_hlm_posY                 = CVar.GetCVar("uz_hhx_"..Namespace.."_name_hlm_posY", sb.CPlayer);
        if (!_name_hlm_scale) _name_hlm_scale               = CVar.GetCVar("uz_hhx_"..Namespace.."_name_hlm_scale", sb.CPlayer);

        if (!_weapon_enabled) _weapon_enabled               = CVar.GetCVar("uz_hhx_"..Namespace.."_weapon_enabled", sb.CPlayer);
        if (!_weapon_nhm_posX) _weapon_nhm_posX             = CVar.GetCVar("uz_hhx_"..Namespace.."_weapon_nhm_posX", sb.CPlayer);
        if (!_weapon_nhm_posY) _weapon_nhm_posY             = CVar.GetCVar("uz_hhx_"..Namespace.."_weapon_nhm_posY", sb.CPlayer);
        if (!_weapon_nhm_scale) _weapon_nhm_scale           = CVar.GetCVar("uz_hhx_"..Namespace.."_weapon_nhm_scale", sb.CPlayer);
        if (!_weapon_hlm_posX) _weapon_hlm_posX             = CVar.GetCVar("uz_hhx_"..Namespace.."_weapon_hlm_posX", sb.CPlayer);
        if (!_weapon_hlm_posY) _weapon_hlm_posY             = CVar.GetCVar("uz_hhx_"..Namespace.."_weapon_hlm_posY", sb.CPlayer);
        if (!_weapon_hlm_scale) _weapon_hlm_scale           = CVar.GetCVar("uz_hhx_"..Namespace.."_weapon_hlm_scale", sb.CPlayer);

        if (!_ekg_enabled) _ekg_enabled                     = CVar.GetCVar("uz_hhx_"..Namespace.."_ekg_enabled", sb.CPlayer);
        if (!_ekg_nhm_posX) _ekg_nhm_posX                   = CVar.GetCVar("uz_hhx_"..Namespace.."_ekg_nhm_posX", sb.CPlayer);
        if (!_ekg_nhm_posY) _ekg_nhm_posY                   = CVar.GetCVar("uz_hhx_"..Namespace.."_ekg_nhm_posY", sb.CPlayer);
        if (!_ekg_nhm_scale) _ekg_nhm_scale                 = CVar.GetCVar("uz_hhx_"..Namespace.."_ekg_nhm_scale", sb.CPlayer);
        if (!_ekg_nhm_length) _ekg_nhm_length               = CVar.GetCVar("uz_hhx_"..Namespace.."_ekg_nhm_length", sb.CPlayer);
        if (!_ekg_hlm_posX) _ekg_hlm_posX                   = CVar.GetCVar("uz_hhx_"..Namespace.."_ekg_hlm_posX", sb.CPlayer);
        if (!_ekg_hlm_posY) _ekg_hlm_posY                   = CVar.GetCVar("uz_hhx_"..Namespace.."_ekg_hlm_posY", sb.CPlayer);
        if (!_ekg_hlm_scale) _ekg_hlm_scale                 = CVar.GetCVar("uz_hhx_"..Namespace.."_ekg_hlm_scale", sb.CPlayer);
        if (!_ekg_hlm_length) _ekg_hlm_length               = CVar.GetCVar("uz_hhx_"..Namespace.."_ekg_hlm_length", sb.CPlayer);

        if (!_encumbrance_enabled) _encumbrance_enabled     = CVar.GetCVar("uz_hhx_"..Namespace.."_encumbrance_enabled", sb.CPlayer);
        if (!_encumbrance_nhm_posX) _encumbrance_nhm_posX   = CVar.GetCVar("uz_hhx_"..Namespace.."_encumbrance_nhm_posX", sb.CPlayer);
        if (!_encumbrance_nhm_posY) _encumbrance_nhm_posY   = CVar.GetCVar("uz_hhx_"..Namespace.."_encumbrance_nhm_posY", sb.CPlayer);
        if (!_encumbrance_nhm_scale) _encumbrance_nhm_scale = CVar.GetCVar("uz_hhx_"..Namespace.."_encumbrance_nhm_scale", sb.CPlayer);
        if (!_encumbrance_hlm_posX) _encumbrance_hlm_posX   = CVar.GetCVar("uz_hhx_"..Namespace.."_encumbrance_hlm_posX", sb.CPlayer);
        if (!_encumbrance_hlm_posY) _encumbrance_hlm_posY   = CVar.GetCVar("uz_hhx_"..Namespace.."_encumbrance_hlm_posY", sb.CPlayer);
        if (!_encumbrance_hlm_scale) _encumbrance_hlm_scale = CVar.GetCVar("uz_hhx_"..Namespace.."_encumbrance_hlm_scale", sb.CPlayer);

        if (!_mugshot_enabled) _mugshot_enabled             = CVar.GetCVar("uz_hhx_"..Namespace.."_mugshot_enabled", sb.CPlayer);
        if (!_mugshot_nhm_posX) _mugshot_nhm_posX           = CVar.GetCVar("uz_hhx_"..Namespace.."_mugshot_nhm_posX", sb.CPlayer);
        if (!_mugshot_nhm_posY) _mugshot_nhm_posY           = CVar.GetCVar("uz_hhx_"..Namespace.."_mugshot_nhm_posY", sb.CPlayer);
        if (!_mugshot_nhm_scale) _mugshot_nhm_scale         = CVar.GetCVar("uz_hhx_"..Namespace.."_mugshot_nhm_scale", sb.CPlayer);
        if (!_mugshot_hlm_posX) _mugshot_hlm_posX           = CVar.GetCVar("uz_hhx_"..Namespace.."_mugshot_hlm_posX", sb.CPlayer);
        if (!_mugshot_hlm_posY) _mugshot_hlm_posY           = CVar.GetCVar("uz_hhx_"..Namespace.."_mugshot_hlm_posY", sb.CPlayer);
        if (!_mugshot_hlm_scale) _mugshot_hlm_scale         = CVar.GetCVar("uz_hhx_"..Namespace.."_mugshot_hlm_scale", sb.CPlayer);
