class UZEKG : HUDEKG {
    ...
    override void Tick(HCStatusbar sb) {
        ...
        if (!_hlm_length) _hlm_length     = CVar.GetCVar("uz_hhx_"..Namespace.."_hlm_length", sb.CPlayer);
        ...
        if (!_nhm_length) _nhm_length     = CVar.GetCVar("uz_hhx_"..Namespace.."_nhm_length", sb.CPlayer);
